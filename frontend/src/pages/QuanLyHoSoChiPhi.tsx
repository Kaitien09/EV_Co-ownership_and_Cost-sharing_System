...
const QuanLyHoSoChiPhi = () => {
  ...
  // Xác nhận thanh toán - CẬP NHẬT
  const handleXacNhanThanhToan = () => {
    if (!selectedHoaDon) return;

    const phuongThucSelected = phuongThucThanhToan.find(pt => pt.id === phuongThucTT);

    // Nếu là phương thức điện tử, hiển thị QR code
    if (phuongThucSelected && phuongThucSelected.loai === "qr") {
      setShowQRCode(true);
    } else {
      // Nếu là tiền mặt, xác nhận thanh toán luôn
      confirmPayment();
    }
  };

  // Hàm hủy thanh toán QR
  const handleHuyThanhToanQR = () => {
    setShowQRCode(false);
    setShowModalThanhToan(true);
  };
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="mb-6">
              ...
              <div className="space-y-3">
                <div>
                  <span className="font-semibold text-gray-800 dark:text-white">Trung tâm thực hiện</span>
                  <p className="text-gray-600 dark:text-gray-400">{selectedHoaDon.trungTam}</p>
                </div>

                <div>
                  <span className="font-semibold text-gray-800 dark:text-white">Số km</span>
                  <p className="text-gray-600 dark:text-gray-400">{selectedHoaDon.soKm.toLocaleString()} km</p>
                </div>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-300 dark:border-gray-600">
                      <th className="text-left p-3 font-semibold text-gray-800 dark:text-gray-200">
                        Tên hạng mục
                      </th>
                      <th className="text-right p-3 font-semibold text-gray-800 dark:text-gray-200">
                        Đơn giá
                      </th>
                    </tr>
                  </thead>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-96">
            ...
            <div className="flex gap-2">
              ...
              >
                {phuongThucThanhToan.find(pt => pt.id === phuongThucTT)?.loai === "qr"
                  ? "Hiển thị QR Code"
                  : "Xác nhận thanh toán"}
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-96">
            ...
            <div className="text-center">
              ...
              <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-8 mb-4 mx-auto w-64 h-64 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-500 mt-2">
                    (Trong ứng dụng thực tế sẽ tích hợp thư viện QR code)
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 mb-4">
                <div className="text-sm space-y-2 text-left">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{phuongThucThanhToan.find(pt => pt.id === phuongThucTT)?.ten}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono">{selectedHoaDon.maDichVu}</span>
                  </div>
                </div>
              </div>

              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Vui lòng quét mã QR bằng ứng dụng {phuongThucThanhToan.find(pt => pt.id === phuongThucTT)?.ten} trên điện thoại của bạn
              </p>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-4">
                Sau khi quét mã và thanh toán thành công, hãy nhấn "Đã thanh toán"
              </p>
            </div>
          </div>
        </div>
